...
### **1. ДЛЯ ПОЛЬЗОВАТЕЛЕЙ:**
- `/start` - Инструкция + ссылки на соцсети
- Кнопка "📝 РЕГИСТРАЦИЯ" - реферальная ссылка
- Кнопка "👑 ПОЛУЧИТЬ ДОСТУП" - инструкция + ID пользователя
- Кнопка "📞 НАПИСАТЬ АДМИНУ" - ссылка на тебя

2. ДЛЯ VIP ПОЛЬЗОВАТЕЛЕЙ:

· 🚀 ПОЛУЧИТЬ СИГНАЛ - точные сигналы по 80+ активам
· 📊 МОЯ СТАТИСТИКА - винрейт, прибыль, плюсы/минусы
· 🏆 ТОП ТРЕЙДЕРОВ - топ 10 с статистикой
· 📅 МАРАФОН 30 ДНЕЙ - полный план от 1 до 30 дня
· 📈 ВСЕ АКТИВЫ - список всех 80+ активов

3. ДЛЯ АДМИНОВ:

· /grant <user_id> - выдать VIP
· /revoke <user_id> - забрать VIP
· /send <сообщение> - рассылка всем
· /admin - админ панель
...
Бот полностью готов! Все функции работают, красивое оформление, реальные сигналы для Pocket Option! 🎯
